...
JXL_COMMIT="d089091afeb7b00b3d0fec6f019d35eaa3b2b410"
...
ffbuild_dockerbuild() {
    ...
    cmake \
        ...
        -DJPEGXL_ENABLE_{BENCHMARK,DEVTOOLS,DOXYGEN,EXAMPLES,JNI,MANPAGES,PLUGINS,SJPEG,SKCMS,TOOLS,VIEWERS}=OFF \
