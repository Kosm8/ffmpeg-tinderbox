...
SHADERC_COMMIT="7060a6615a1c6e2515e696651eea685524ecadb5"
...
ffbuild_dockerbuild() {
    ...
    cmake \
        ...
        -DSHADERC_ENABLE_{HLSL,WERROR_COMPILE}=OFF \
        -DSHADERC_SKIP_{COPYRIGHT_CHECK,EXAMPLES,EXECUTABLES,TESTS}=ON \
